...
const characterSamples = {
    "Townsfolk": [
        ...
        { name: "Artist", value: "Player('Adam', claim=Artist, night_info={\n    1: Artist.Ping(IsCharacter(Louisa, Drunk))\n),\n"},
    ...
    "Minions": [
        ...
        { name: "Marionette", value: "Player('Fraser', claim=Marionette),\n"},
        { name: "Poisoner", value: "Player('Fraser', claim=Poisoner),\n"},
        { name: "ScarletWoman", value: "Player('Fraser', claim=ScarletWoman),\n"},
        { name: "Spy", value: "Player('Fraser', claim=Spy),\n"},
        { name: "Widow", value: "Player('Fraser', claim=Widow), # TODO!\n"},
        { name: "Witch", value: "Player('Fraser', claim=Flowergirl, day_info={\n    1: Dies(after_nominating=True)\n}),\n"},
        { name: "Xaan", value: "Player('Fraser', claim=Xaan),\n"},
    ],
    "Demons": [
